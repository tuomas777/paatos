# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-10-14 13:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actions', models.ManyToManyField(blank=True, help_text='Actions related to this event', related_name='events', to='decisions.Action')),
            ],
            options={
                'abstract': False,
            },
